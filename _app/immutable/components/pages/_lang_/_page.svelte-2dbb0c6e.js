...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(div0, "class", "svelte-19uvke6");
      attr(p, "class", "bubble svelte-19uvke6");
    },
    m(target, anchor) {
