...
function create_fragment(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(div0, "class", "svelte-nox2jy");
      attr(p, "class", "bubble svelte-nox2jy");
      attr(div1, "id", "about-container");
      attr(div1, "class", "svelte-nox2jy");
    },
    m(target, anchor) {
