import { S as SvelteComponent, i as init, s as safe_not_equal, k as element, a as space, x as create_component, l as claim_element, m as children, c as claim_space, h as detach, y as claim_component, p as set_style, n as attr, M as src_url_equal, b as insert_hydration, K as append_hydration, z as mount_component, f as transition_in, g as group_outros, t as transition_out, d as check_outros, A as destroy_component, L as component_subscribe, q as text, r as claim_text, u as set_data, N as add_render_callback, O as create_in_transition, P as create_out_transition, C as noop, D as subscribe, Q as listen, E as run_all, R as null_to_empty, o as onMount, v as binding_callbacks, e as empty, T as head_selector, B as tick, U as globals, V as bind, W as add_flush_callback, G as create_slot, H as update_slot_base, I as get_all_dirty_from_scope, J as get_slot_changes } from "../../../chunks/index-129eb85f.js";
import { t, l as locale } from "../../../chunks/translations-f4fcc980.js";
import { p as page } from "../../../chunks/stores-e463fd20.js";
import { b as blur, a as blurIn, c as blurOut } from "../../../chunks/customBlur-76bf72bd.js";
import { N as Name } from "../../../chunks/Name-73ed4a9e.js";
const _900 = "";
const _400$1 = "";
const _400 = "";
...
function create_if_block$1(ctx) {
  ...
  return {
    ...
    h() {
      attr(span, "class", "home-link svelte-gsyj7d");
    },
    m(target, anchor) {
...
function create_fragment$3(ctx) {
  ...
  let if_block = (
    /*$page*/
    ctx[3].route.id !== "/[lang]" && create_if_block$1(ctx)
  );
  name = new Name({});
  return {
    c() {
    ...
    h() {
      ...
      attr(img0, "class", "profile-photo svelte-gsyj7d");
      ...
      attr(img1, "class", "profile-photo svelte-gsyj7d");
      attr(img1, "id", "blur");
      if (!src_url_equal(img1.src, img1_src_value = profilePhoto))
        attr(img1, "src", img1_src_value);
      attr(img1, "alt", "");
      attr(a, "class", "profile-photo-container svelte-gsyj7d");
      attr(a, "href", a_href_value = "/" + /*$lang*/
      ctx[2]);
      attr(div, "id", "name-container");
      attr(div, "class", "svelte-gsyj7d");
    },
    m(target, anchor) {
...
function instance$3($$self, $$props, $$invalidate) {
  ...
  return [lang, darkMode, $lang, $page, $t];
}
...
function create_fragment$1(ctx) {
  ...
  return {
    ...
    h() {
      ...
      attr(div1, "class", "svelte-14qcfkb");
    },
    m(target, anchor) {
...
function create_if_block(ctx) {
  ...
  return {
    ...
    h() {
      var _a, _b, _c;
      attr(div0, "class", "link-group svelte-ibi6wr");
      attr(a0, "href", "https://github.com/jaakkonakaza");
      attr(a0, "class", "svelte-ibi6wr");
      attr(a1, "href", "https://www.linkedin.com/in/jaakkonakaza/");
      attr(a1, "class", "svelte-ibi6wr");
      attr(div1, "class", "link-group svelte-ibi6wr");
      attr(button, "class", "svelte-ibi6wr");
      attr(a2, "data-sveltekit-preload-data", "tap");
      attr(a2, "href", a2_href_value = "/en" + /*$page*/
      ((_a = ctx[1].route.id) == null ? void 0 : _a.substring(7)));
      attr(a2, "class", "svelte-ibi6wr");
      attr(a3, "data-sveltekit-preload-data", "tap");
      attr(a3, "href", a3_href_value = "/fi" + /*$page*/
      ((_b = ctx[1].route.id) == null ? void 0 : _b.substring(7)));
      attr(a3, "class", "svelte-ibi6wr");
      attr(a4, "data-sveltekit-preload-data", "tap");
      attr(a4, "href", a4_href_value = "/ja" + /*$page*/
      ((_c = ctx[1].route.id) == null ? void 0 : _c.substring(7)));
      attr(a4, "class", "svelte-ibi6wr");
      attr(div2, "id", "languages");
      attr(div2, "class", "svelte-ibi6wr");
      attr(div3, "class", div3_class_value = "column " + /*$page*/
      (ctx[1].route.id !== "/[lang]" ? "links-hidden" : "") + " svelte-ibi6wr");
    },
    m(target, anchor) {
    ...
    p(ctx2, dirty) {
      ...
      2 && a2_href_value !== (a2_href_value = "/en" + /*$page*/
      ((_a = ctx2[1].route.id) == null ? void 0 : _a.substring(7)))) {
        attr(a2, "href", a2_href_value);
      }
      if (!current || dirty & /*$page*/
      2 && a3_href_value !== (a3_href_value = "/fi" + /*$page*/
      ((_b = ctx2[1].route.id) == null ? void 0 : _b.substring(7)))) {
        attr(a3, "href", a3_href_value);
      }
      if (!current || dirty & /*$page*/
      2 && a4_href_value !== (a4_href_value = "/ja" + /*$page*/
      ((_c = ctx2[1].route.id) == null ? void 0 : _c.substring(7)))) {
        attr(a4, "href", a4_href_value);
      }
      if (!current || dirty & /*$page*/
      2 && div3_class_value !== (div3_class_value = "column " + /*$page*/
      (ctx2[1].route.id !== "/[lang]" ? "links-hidden" : "") + " svelte-ibi6wr")) {
...
function create_key_block(ctx) {
  ...
  return {
    ...
    h() {
      attr(div1, "class", "column svelte-ibi6wr");
      attr(div1, "id", "page-content");
      attr(nav, "class", "column svelte-ibi6wr");
      attr(nav, "id", "nav-content");
      attr(div3, "id", "container");
      attr(div3, "class", "svelte-ibi6wr");
    },
    m(target, anchor) {
...
var BackgroundColor = /* @__PURE__ */ ((BackgroundColor2) => {
  ...
  BackgroundColor2["Coral"] = "coral";
  BackgroundColor2["Grey"] = "grey";
...
function instance($$self, $$props, $$invalidate) {
  ...
  $$self.$$.update = () => {
    if ($$self.$$.dirty & /*$page*/
    2) {
      $$invalidate(10, currentPageBackgroundColor = $page.route.id === "/[lang]/workHistory" ? BackgroundColor.Green : $page.route.id === "/[lang]/projects" ? BackgroundColor.Blue : $page.url.hash === "#o1" ? BackgroundColor.LightBlue : $page.url.hash === "#courses" ? BackgroundColor.Pink : $page.url.hash === "#studios" ? BackgroundColor.Grey : $page.url.hash === "#five" ? BackgroundColor.Coral : $page.route.id === "/[lang]/graphicDesign" ? BackgroundColor.Orange : void 0);
    }
