...
const japanese = {
	...
	role: 'ソフト開発者',
	about:
		'私はフィンランド出身のソフトウェア開発者で、現在アールト大学でコンピューターサイエンスを専攻し、トゥルク大学で日本語を副専攻しています。また、アールト大学ではソフトウェア開発者兼主任教育アシスタントとして働いています。私は教育ツール、アプリケーション、ユーザーインターフェースの開発経験があります。得意なプログラミング言語はTypeScript、Java、Scalaで、React.jsを使ったWebアプリケーション開発、React Nativeを使ったモバイルアプリケーション開発に強い理解を持っています。また、ロゴやブランディングのデザインなど、グラフィックデザインにも熟練しています。私のソフトウェア開発とデザインの専門知識により、クライアントのニーズに応える効率的でユーザーフレンドリーなソリューションを創出することができます。',
	home: 'ホーム',
	workHistory: '職歴',
	projects: 'プロジェクト',
